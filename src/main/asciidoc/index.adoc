...
It is the hash() of a Base 64 encoded PEM formatted file (X.509 ASN.1 1583 encoding), following the RFC 5280 [CSF+08] specification,
...
include::{snippets}/beacon/2.0/pulse/time/last/get-last/path-parameters.adoc[]
